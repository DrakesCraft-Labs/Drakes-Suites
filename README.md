...
| **Suite 2** | `drakes-bio.jar` | Bio-Genetics & Agriculture | **Native Ported Modules:** `TreeTapsModule` (SlimyTreeTaps: bio-resin, amber, rubber, tree stripping), GeneticChickengineering (Tiers 0 to 9 with cloning and gene-splicing), ExoticGarden, Cultivation, SlimyBees, MobCapturer, Gastronomicon, FlowerPower, Drugfun, GlobalWarming. |
