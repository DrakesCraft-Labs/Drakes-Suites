...
| **Suite 2** | `drakes-bio.jar` | Biogenética & Campo | **Módulos nativos integrados:** `TreeTapsModule` (SlimyTreeTaps: resina, ámbar, caucho, descortezado), GeneticChickengineering (Tiers 0 a 9 con clonación y empalme genético), ExoticGarden, Cultivation, SlimyBees, MobCapturer, Gastronomicon, FlowerPower, Drugfun, GlobalWarming. |
